    ...
    <div className="w-full">
      ...
      <Accordion type="multiple" className="w-full divide-y-2 divide-zinc-100">
        {vendors.map((vendor) => {
          ...
          return (
            <AccordionItem key={vendor.id} value={vendor.id} className="border-b border-zinc-200 px-6 hover:bg-zinc-50 transition-colors">
              <AccordionTrigger className="hover:no-underline py-6">
                <div className="flex items-center gap-4 text-left">
                  <div className="h-12 w-12 rounded-none bg-zinc-200 border-2 border-zinc-300 flex items-center justify-center text-black">
                    <Package className="h-6 w-6" />
                  </div>
                  <div>
                    <div className="font-black text-xl text-black">{vendor.name}</div>
                    <div className="text-sm text-zinc-600 font-bold mt-1">
                  ...
                  <table className="w-full text-base">
                    ...
                    <tbody>
                      ...
                      {vendor.products.length === 0 && (
                        <tr>
                          <td colSpan={2} className="py-12 text-center text-zinc-500 font-bold text-base italic">
